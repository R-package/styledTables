...
use the `styledTables` package. Therefore, we implemented the following functions,
...
We will need a [tidy data set] to illustrate the power of `styledTables` cross table creation.
