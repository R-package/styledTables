...
[Resulting Excel file](`r fig_path("ex2.xlsx")`)
...
[Resulting pdf file](`r fig_path("test.pdf")`) and
[Resulting png file](`r fig_path("test.png")`)
...
[Rnw file](`r fig_path("ex2.Rnw")`) and [Resulting PDF file](`r fig_path("ex2.pdf")`)
