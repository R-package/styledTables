...
and save the styled table as a `PNG`.
...
```
<p>
<img src="ex1.png" width="60%" height="60%">
</p>
...
<p>
<img src="ex2.png" width="60%" height="60%">
</p>
...
# save the workbook
saveWorkbook(wb, "../docs/test.xlsx")
```

[Resulting Excel file](../test.xlsx)
...
```{r, code=readLines("ex2.Rnw"), eval=FALSE}
```

```{r, include=FALSE}
system("cp ex2.Rnw ../docs/")
...
system(
    paste(
        "cp", file.path(old_wd, "ex2.Rnw"), tmp,
        "&& cd", tmp,
        paste0(
