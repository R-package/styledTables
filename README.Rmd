...
Currently is `styledtable` under heavy development. Unfortunately,
the current state is not fully stable. 

If you want to use `styledtable`, we recommend the **last stable version**,
which came under the **old package name** `styledTables`:
