...
(see [https://pagedown.rbind.io/](https://pagedown.rbind.io/)), which are fully accessible to assistive reading devices and come along with
all the nice bookbinding features that LaTeX offers.
Unfortunately, there won't be any more support for this legacy package.
